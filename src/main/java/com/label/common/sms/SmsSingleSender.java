...
public class SmsSingleSender extends SmsBase {
    ...
    public SmsSingleSenderResult send(int type, String nationCode, String phoneNumber,
        ...
        try {
            ...
            return (new com.github.qcloudsms.SmsSingleSenderResult()).parseFromHTTPResponse(res);
     ...
     * @throws IOException    network problem
     */
    public com.github.qcloudsms.SmsSingleSenderResult sendWithParam(String nationCode, String phoneNumber, int templateId,
